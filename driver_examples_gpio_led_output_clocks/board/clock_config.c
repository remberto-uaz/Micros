...
#define SIM_UART_CLK_SEL_MCGIRCLK_CLK                     3U  /*!< UART clock select: MCGIRCLK clock */
...
- {id: UART0CLK.outFreq, value: 4 MHz}
settings:
...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_SetLpsci0Clock(SIM_UART_CLK_SEL_MCGIRCLK_CLK);
}
