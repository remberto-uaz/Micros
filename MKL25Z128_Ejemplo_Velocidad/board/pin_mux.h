...
/*!
 * @brief TPM0 External Clock Pin Select: TPM0 external clock driven by TPM_CLKIN0 pin. */
#define SOPT4_TPM0CLKSEL_CLKIN0 0x00u
/*!
 * @brief UART0 receive data source select: UART0_RX pin */
#define SOPT5_UART0RXSRC_UART_RX 0x00u
/*!
 * @brief UART0 transmit data source select: UART0_TX pin */
